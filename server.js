...
/* ============================ SUSPENSION : PAGE D'ADMINISTRATION ============================ */
app.get('/admin', requireAdminAuth, (req, res) => {
  const rows = Object.keys(revokedDevices).sort().map(code => `
    <tr>
...
<html lang="fr">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Administration — Devis Pro</title>${SHARED_STYLE}</head>
<body>
<div class="card" style="max-width:640px;">
  <h1>Administration des licences</h1>
  <div class="sub">Suspendez ou réactivez une licence à distance. Effet uniquement si l'appareil du client a internet au prochain lancement de l'app.</div>
  ...
  <div style="margin-top:30px;">
    ...
    <table style="width:100%;border-collapse:collapse;margin-top:10px;">
      <tr style="text-align:left;font-size:12px;color:var(--muted);text-transform:uppercase;">
        <th style="padding:6px;">Code appareil</th><th style="padding:6px;">Suspendu le</th><th></th>
      </tr>
      ${rows}
    </table>`}
  </div>
